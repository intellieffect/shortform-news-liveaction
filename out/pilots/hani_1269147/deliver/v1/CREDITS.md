...
- 행성·적색왜성·림·별 원반 이미지/영상: Higgsfield MCP 생성(gpt_image_2_5, kling3_0) — 상상도, 관측 아님. 화면에 표기.
- 도해(세 조건·골디락스·TRAPPIST 개념도·기체 분리·통과/흡수선·무거운 층): 코드(Remotion). 원리 개념도.
...
- 내레이션: Higgsfield qwen_audio_tts preset "Mark", 한국어, speech_rate 1.1.
