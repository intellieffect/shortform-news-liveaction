...
const usage = [
  ...
  "produce begin <id> narration|proof|render|review_visual|review_audio|review_facts [--output <새 파일>]...",
  "produce finish <id> <token>",
  "produce fail <id> <token> --reason <실패 이유>",
  "produce invalidate <id> <action> --reason <의미 변경 이유>",
  "produce review-input <id> --source preview|render --phase experience|intent",
