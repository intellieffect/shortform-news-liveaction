...
**`plugin/` 이 납품 단위다.** 제작 판단 — 절차(스킬)·분리된 검증(에이전트)·렌더 전 가드(훅) — 를 담아, 한겨레가 우리 없이 기사 한 편을 9:16 뉴스 영상으로 만들 수 있게 하는 것이 목표다. 영상이 아니라 이 능력이 계약의 산출물이다 ([근거](../docs/research/2026-09-04-deliverable-drift/summary.md)).
